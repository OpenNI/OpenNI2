...
void LinkOniColorStream::GetAllowedOniOutputFormatForInputFormat(XnIOImageFormats inputFormat, OniPixelFormat *aOniFormats, int *nOniFormats)
{
	*nOniFormats = 0;
...
XnBool LinkOniColorStream::IsSupportedInputFormat(XnIOImageFormats inputFormat, OniPixelFormat oniFormat)
{
	return IsPreferredInputFormat(inputFormat, (XnIOImageFormats)XN_MAX_UINT32, oniFormat);
}

XnBool LinkOniColorStream::IsPreferredInputFormat(XnIOImageFormats inputFormat, XnIOImageFormats thanFormat, OniPixelFormat oniFormat)
{
...
LinkOniColorStream::LinkOniColorStream(XnSensor* pSensor, LinkOniDevice* pDevice) : 
	LinkOniMapStream(pSensor, XN_STREAM_TYPE_IMAGE, ONI_SENSOR_COLOR, pDevice)
{
}
