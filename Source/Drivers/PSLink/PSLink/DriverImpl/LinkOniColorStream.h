...
*                                                                            *
*****************************************************************************/
#ifndef __LINK_ONI_COLOR_STREAM_H__
#define __LINK_ONI_COLOR_STREAM_H__
...
// Types
//---------------------------------------------------------------------------
class LinkOniColorStream :
	public LinkOniMapStream
{
public:
	LinkOniColorStream(XnSensor* pSensor, LinkOniDevice* pDevice);
...
#endif // __LINK_ONI_COLOR_STREAM_H__
